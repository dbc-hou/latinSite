...
const peopleAnswers = [
  ...
  "<em>dictator, temporary military ruler</em>—<strong>dictātōris/dictātrīcis</strong>",
  "<em>teacher, professor, physician</em>—<strong>doctōrem/doctrīcem</strong>",
  ...
  "<em>commander, general, emperor</em>—<strong>imperātōrī/imperatrīcī</strong>",
  ...
  "<em>narrator, storyteller</em>—<strong>narrātōre/narrātrīce</strong>",
  "<em>grandchild, niece, nephew</em>—<strong>nepōtem</strong>",
  "<em>orator, persuasive speaker</em>—<strong>ōrātōrum/ōrātrīcum</strong>",
  "<em>order, rank, socioeconomic class</em>—<strong>ōrdō</strong>",
  "<em>part, direction</em>—<strong>partibus</strong>",
  "<em>shepherd</em>—<strong>pastōribus/pastrīcibus</strong>",
  "<em>father</em>—<strong>patrēs</strong>",
  "<em>chief, emperor</em>—<strong>prīncipibus</strong>",
  "<em>king, ruler</em>—<strong>rēge</strong>",
  "<em>senator</em>—<strong>senātōribus/senātrīcibus</strong>",
  "<em>sister</em>—<strong>soror</strong>",
  "<em>spectator, onlooker</em>—<strong>spectātōrēs/spectātrīcēs</strong>",
  "<em>wife</em>—<strong>uxōrēs</strong>",
  "<em>victor, conqueror</em>—<strong>victōrēs/victrīcēs</strong>",
